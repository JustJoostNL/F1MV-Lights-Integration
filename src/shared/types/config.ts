import { RGBColor } from "./integration";
...
export const eventTypeReadableMap: Record<EventType, string> = {
  ...
  OvertakeModeEnabled: "Overtake Mode Enabled",
  OvertakeModeDisabled: "Overtake Mode Disabled",
  StraightLineModeLowGrip: "Straight Line Mode Low Grip",
  StraightLineModeNormalGrip: "Straight Line Mode Normal Grip",
  StraightLineModeDisabled: "Straight Line Mode Disabled",
...
export enum EventType {
  ...
  OvertakeModeEnabled = "OvertakeModeEnabled",
  OvertakeModeDisabled = "OvertakeModeDisabled",
  StraightLineModeLowGrip = "StraightLineModeLowGrip",
  StraightLineModeNormalGrip = "StraightLineModeNormalGrip",
  StraightLineModeDisabled = "StraightLineModeDisabled",
...
export enum ActionType {
  ...
  OFF = "Off",
  DELAY = "Delay",
  GO_BACK_TO_CURRENT_STATUS = "GoBackToCurrentStatus",
}
