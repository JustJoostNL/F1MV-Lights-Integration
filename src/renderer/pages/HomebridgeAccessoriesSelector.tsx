...
export function HomebridgeAccessoriesSelector() {
    ...
    const { data, mutate } = useSWR(
        ...
        async () => {
            ...
            return { accessories: data.accessories, selectedDevices: data.selectedAccessories };
        },
    ...
    const handleSelectionModelChange = useCallback(
        (newSelection: GridRowId[]) => {
            ...
            const selectedAccessoriesIds = selectedAccessories.map((device) => device.id);
